const data = {
      ...
      project: {
            'ae01f519-a68e-44b3-8de0-b52cdb7e4522': {
                  ...
                  tasks: {
                        '7d45c70b-c8ce-471f-ab15-d10b0be11400': {
                        ...
                        'd232c2e4-2f33-4d9f-8296-a5ff0abd7336': {
                              title: 'pomodor timer',
                              startDate: '2026-05-26',
                              taskDescription:
                        ...
                        '54306cf8-bf17-4795-a629-f52f31b40b01': {
                              title: 'reading list',
                              startDate: '2026-05-26',
                              taskDescription: 'Create a reading list tracker',
                              taskStatus: 'completed',
                        },
                        'b7679fb6-7625-4887-b1ab-8af9c5cb42b4': {
            ...
            'bb12c729-b42d-4d31-91f7-7cb5a8d41234': {
                  ...
                  tasks: {
                        'c7e4d2e3-0069-4ea0-9d3d-4a89fedc9700': {
                              title: 'game setup',
                              startDate: '2026-05-28',
                              taskDescription:
                        ...
                        '8883ff7a-2488-4e4b-81b3-e2094eaebc05': {
                        ...
                        'bcaa7f64-d8d5-4694-8edd-c69372177d4a': {
                        ...
                        '0808c575-8955-4aec-aa35-55d7d902853c': {
                              title: 'responsive ui',
                              startDate: '2026-05-28',
                              taskDescription:
                        ...
                        '6d861638-f302-4e4f-a9af-3608ab722ed0': {
                              title: 'deployment',
                              startDate: '2026-05-28',
                              taskDescription:
      ...
      tasks: {
            ...
            'd6dd24c3-ce73-487f-b830-be3128097f1e': {
                  ...
                  description:
                        'Implement filtering by active and completed tasks',
                  status: 'pending',
                  category: 'project',
            },
            ...
            '4e9e1387-1dbd-40c8-8d17-32513b6516ad': {
                  ...
                  description:
                        'Separate dashboard widgets into reusable folders',
                  status: 'active',
                  category: 'project',
            },
...
export { data, dayNames, monthNames };
